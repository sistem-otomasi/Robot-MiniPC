...
from robotwin.utils.config import load_config, create_default_config
...
async def test_component(args: argparse.Namespace) -> None:
    ...
    from robotwin.utils.config import load_config
...
async def test_motors(config) -> None:
    ...
    from robotwin.hardware.motors import create_motor_controller
...
async def test_lidar(config) -> None:
    """Test LiDAR sensor"""
    from robotwin.hardware.sensors import LidarSensor
...
async def test_camera(config) -> None:
    """Test camera"""
    from robotwin.hardware.sensors import CameraSensor
...
async def test_imu(config) -> None:
    """Test IMU sensor"""
    from robotwin.hardware.sensors import IMUSensor
